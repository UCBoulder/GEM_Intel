...
real function revers(num,n)
  integer*8 :: num,n,inum,iquot,irem
  real :: rev,power
...
! Code was translated using: /nfs/site/home/tkloeffe/TCE/intel-application-migration-tool-for-openacc-to-openmp/src/intel-application-migration-tool-for-openacc-to-openmp gem_fcnt.F90
